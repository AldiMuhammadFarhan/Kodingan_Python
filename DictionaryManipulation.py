...
print(info_karyawan)
# Fitur .copy()
# Mengembalikan copy dari setiap elemen dalam set. Serupa dengan fitur copy() 
# pada tipe data collections lainnya, fitur copy() tidak akan mengubah nilai dari elemen asal seperti 
# fungsi assignment.
print(">>> Fitur .copy()")
